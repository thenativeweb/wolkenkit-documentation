...
metadata.navigation = [
  ...
  { title: 'Advanced guides', children: [
  ...
  { title: 'Reference', children: [
    ...
    { title: 'Using blob storage', children: [
      { title: 'Accessing blob storage', keywords: [ 'file' ]},
      { title: 'Adding blobs', keywords: [ 'file', 'upload' ]},
      { title: 'Getting blobs', keywords: [ 'file', 'download' ]},
      { title: 'Removing blobs', keywords: [ 'file' ]},
      { title: 'Configuring authorization', keywords: [ 'file' ]}
    ]},
