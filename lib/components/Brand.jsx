...
const Brand = function (props) {
  let brandClasses = 'wk-brand';

  if (props.isCollapsed) {
    brandClasses += ' wk-brand--collapsed';
  }

  return (
    <div className={ brandClasses }>
      <Logo isVisible={ props.showLogo } />
      <div className='wk-brand-typo'><span>wolken</span>kit</div>
      <div className='wk-brand-suffix'>{props.suffix}</div>
    </div>
  );
};
